...
def my_profile():
    ...
    return render_template("profile_page.html", researcher=user, is_owner=True, publications=publications, section_order=section_order)
...
def researcher_profile(researcher_id):
    ...
    return render_template("profile_page.html", researcher=researcher, is_owner=is_owner, publications=publications, section_order=section_order)
